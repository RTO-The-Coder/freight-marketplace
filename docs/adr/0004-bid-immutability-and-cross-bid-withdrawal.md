...
## Consequences
- Simpler Bid state machine and simpler UI (no edit-bid flow to build in Slice 7) — trades away a feature real dispatchers might want (adjusting a submitted bid) for a smaller set of states and transitions to reason about.
